...
- `composer create-project symfony/skeleton:"7.*" apptemp` to create the symfony project
...
#### mariadb|postgres|mysql setup
- run `echo "/docker/postgres/" >> .gitignore` to ignore the postgres folder
- run `echo "/.idea/" >> .gitignore` to ignore the idea folder

#### inside the container setup symfony
- `composer require jbsnewmedia/symfony-web-pack` to install the webapp bundle